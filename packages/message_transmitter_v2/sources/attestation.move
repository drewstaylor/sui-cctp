...
module message_transmitter_v2::attestation {
  // === Imports ===
  ...
  use message_transmitter_v2::state::{State};
  use message_transmitter_v2::vector_utils;
  ...
  #[test_only] use message_transmitter_v2::attester_manager::{Self};
